            ...
            <div class="lg:-mx-6 lg:flex lg:items-center">
               ...
               @endif
                    <div class="flex items-center justify-between mt-12 lg:justify-start">
                            ...
                            <a href="{{route('provider.activities.edit', $activity->id )}}" class="p-2 text-gray-800 transition-colors duration-300 border rounded-full rtl:-scale-x-100 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-800 hover:text-yellow-500">
                                <span class="material-symbols-outlined hover:text-yellow-500">
                                    edit
                                </span>
                            </a>
                            <form action="{{route('provider.activities.destroy', $activity->id )}}" method="post">
                                @method('DELETE')
                                @csrf
                                <button type="submit" class="p-2 text-gray-800 transition-colors duration-300 border rounded-full rtl:-scale-x-100 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-800 lg:mx-6">
