<x-user.navbar>
    <section class=" bg-gray-50 px-6  mx-auto dark:bg-gray-900">
        <div class="container  px-6 py-12 mx-auto">
            <div>
                <p class="font-medium text-blood-red dark:text-blue-400">Contact us</p>

                <h1 class="mt-2 text-2xl font-semibold text-gray-800 md:text-3xl dark:text-white">Chat to our friendly
                    team</h1>

                <p class="mt-3 text-gray-500 dark:text-gray-400">Have an adventure to share? 🌟 Contact us to get started! Interested in becoming
                    a guide or activity provider?<br> Join our team and shape unforgettable experiences
                    with us. 🚀</p>
            </div>
            ...
            <div class="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
                <div class="grid grid-cols-1 gap-12 md:grid-cols-2">
                    <div>
                        <span class="inline-block p-3 text-cornell-red rounded-full bg-red-100/80 dark:bg-gray-800">
                        ...
                        <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">DadesAdventures@gmail.com</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">+212 (555) 000-0000</p>
                    </div>
                </div>
                ...
                <div class="p-4 py-6 rounded-lg bg-gray-100 dark:bg-gray-800 md:p-8">
                    <form>
                        ...
                        <button
                            class="w-full px-6 py-3 mt-4 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-cornell-red rounded-lg hover:bg-blood-red focus:outline-none focus:ring focus:ring-red-300 focus:ring-opacity-50">
                            Send message
                        </button>
                    </form>
                </div>
