        ...
        <div class="container flex flex-col items-center px-4 py-12 mx-auto xl:flex-row">
            ...
            <div class="flex flex-col items-center mt-6 xl:items-start xl:w-1/2 xl:mt-0">
                ...
                <p class="block max-w-2xl mt-4 text-gray-500 dark:text-gray-300">Lorem ipsum dolor sit amet consectetur
                    adipisicing elit. Ex similique sequi aliquam possimus commodi illo quia libero doloremque corporis
                    ut, doloribus ab beatae molestias eveniet praesentium vel aliquid aspernatur dolorem!
                    Ipsum nemo qui nihil exercitationem hic. Pariatur, aspernatur earum. Hic ad unde ullam aspernatur
                    fugiat exercitationem cum amet odit, tenetur quaerat magni architecto officia sapiente. Voluptate
                    sed aspernatur voluptatibus explicabo?
                    Quod debitis obcaecati unde esse reiciendis corrupti velit illum libero, perferendis quia error
                    itaque! Quisquam libero animi praesentium a eius saepe delectus quaerat qui similique eos, fugit
                    minima temporibus consequuntur! </p>

                <div class="flex p-4  mt-6 sm:-mx-2">
                    @if ($activity->guide)
                    <div class="flex w-full max-w-sm overflow-hidden bg-gray-200 rounded-lg shadow-md dark:bg-gray-800">
                        ...
                        <div class="flex items-center px-2 py-3">
                            ...
                            <div class="mx-3">
                                <p class="text-gray-600 dark:text-gray-200">Official Tour Guide<a
                                        class="text-blue-500 dark:text-blue-300 hover:text-blue-400 hover:underline"> {{$activity->guide->first_name}} {{$activity->guide->last_name}}</a>.</p>
                            </div>
                        </div>
                    </div>
                    @endif
