<x-user.navbar>
    ...
    <section class="  bg-delft-blue dark:bg-gray-900">
        <div class="container px-6 py-10  max-w-screen-xl mx-auto">
            <div class="text-center">
                <h1 class="text-2xl font-semibold text-gray-200 capitalize lg:text-3xl dark:text-white">Popular Things
                    To Do</h1>
            ...
            <div class="grid grid-cols-1 gap-2 mt-8 xl:mt-12 xl:gap-4 md:grid-cols-2 xl:grid-cols-4">
                <div class="overflow-hidden bg-cover  cursor-pointer h-96 group"
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="container px-6 py-10 max-w-screen-xl mx-auto">
            <div class="text-left">
                <h1 class="text-2xl font-semibold text-gray-600 capitalize dark:text-white">Top destinations for your next holiday</h1>
