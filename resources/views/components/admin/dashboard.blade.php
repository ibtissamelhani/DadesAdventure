            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <a href="" class="flex ms-2 md:me-24">
                        <img src="{{ asset('images/logo1.png') }}" class="h-8 me-3" alt="FlowBite Logo" />
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    ...
                    <ul id="dropdown-example" class="hidden py-2 space-y-2">
                        ...
                        <li>
                            <a href="#"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Guides</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul id="dropdown-example2" class="hidden py-2 space-y-2">
                        <li>
                            <a href="#"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Place</a>
                        </li>
                        <li>
                            <a href="#"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Place
                                Types</a>
                        </li>
                    </ul>
                </li>
